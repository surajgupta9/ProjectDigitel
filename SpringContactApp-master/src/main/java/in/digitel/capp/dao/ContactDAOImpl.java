...
import in.digitel.capp.rm.ContactRowMapper;
...
public class ContactDAOImpl extends BaseDAO implements ContactDAO {
    ...
    public void save(Contact c) {
        String sql = "INSERT INTO contact(userId, name, phone, address, email, remark) VALUES(:userId, :name, :phone, :address,:email, :remark)";
        Map m = new HashMap();
    ...
    public List<Contact> findAll() {
        String sql = "SELECT contactId, userId, name, phone, address, email, remark FROM contact";
        return getJdbcTemplate().query(sql, new ContactRowMapper());
    }

    @Override
    public List<Contact> findByProperty(String propName, Object propValue) {
        String sql = "SELECT contactId, userId, name, phone, address,email, remark FROM contact WHERE "+propName+"=?";
